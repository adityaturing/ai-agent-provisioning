...
## How to publish as a GitHub Wiki
- Option A: Create/update repo wiki
  - Clone the wiki: `git clone https://github.com/<org>/<repo>.wiki.git`
  - Save this content as `Home.md` or `AI-Agent-Provisioning.md`
  - Commit and push; open the Wiki tab to view
- Option B: Store in `docs/` and render via your site or GitHub Pages

## How to create a PDF from this page
- Easiest: Open the wiki (or the Markdown in your IDE), print to PDF from the browser
- Pandoc:
  - Install: `brew install pandoc`
  - Convert: `pandoc README.md -o AI-Agent-Provisioning.pdf --pdf-engine=wkhtmltopdf`
- Node md-to-pdf (if Node is available):
